...
@section('content')
<div class="row">
   &nbsp; &nbsp; <a href="{{ route('chauffeurs.create')}}" class="btn btn-primary btn-flat btn-addon m-b-10 m-l-5"><i class="ti-plus"></i>Ajouter</a>
    <div class="col-lg-12">
        <div class="card">
                ...
                <div class="table-responsive">
                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center"> {{ $chauffeur->nom }} </td>
                                <td class="text-center">{{ $chauffeur->prenom }}</td>
                                <td class="text-center">{{ $chauffeur->telephone }}</td>
                                <td class="text-center">
                                    <form action="{{ route('chauffeurs.destroy', $chauffeur->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')

                                        <a href="{{ route('chauffeurs.show', $chauffeur->id) }}" class="btn btn-warning"><i class="ti-eye"></i></a>
                                        <a href="{{ route('chauffeurs.edit', $chauffeur->id) }}" class="btn btn-info"><i class="ti-pencil-alt2"></i></a>
